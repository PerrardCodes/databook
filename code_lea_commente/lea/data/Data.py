...
class Data:
	"""
	:param fichier: Passage en paramètre de la vidéo/image à traiter, ou dictionnaire contenant ses informations
	:type fichier: dict or adresse
	:param param: Nécessaire à la création de l'objet Param
	:type param: dict or adresse
	:param spec: Nécessaire à la création de l'objet Param
	...
	def get_name(self):
		"""
        :return: Le nom de l'objet, ici "Data"
	...
	def get_im_ref(self):
		"""
		:return: Renvoie l'image PIL de référence

		Pour savoir comment l'affichier ou la sauvegarder aller voir : PIL
		"""
		#Renvoie une image PIL
