...
def convert_arbo(ref, adresse_s):
	"""
	Convertit récursivement tout les fichiers (.jpg, .png, .tif, .cine) en fichier HDF5

	:param ref: Adresse du dossier parent
	:param adresse_s: Adresse où on sauvegarde les fichiers hdf5
	:returns: None
	"""
...
def convert_files(adresse, adresse_s):
	"""
	:param ref: Adresse du dossier parent
	:param name_dir: Nom du dossier courant
	:param adresse: ref + "/" + name_dir
	:param adresse_s: Adresse où l'on sauvegarde les fichiers hdf5
	"""
